...
function BoardContent({ board, createNewColumn, createNewCard, moveColumns, moveCardIntheSameColumn, moveCardToDifferentColumn, deleteColumnDetails, deleteCard }) {
    ...
    <>
      <DndContext
        ...
        <Box sx={{
          ...
          <ListColumns columns={orderedColumns} createNewColumn={ createNewColumn } createNewCard={ createNewCard } deleteColumnDetails = { deleteColumnDetails } deleteCard = { deleteCard }/>
